...
def main():
    ...
    seq_info = [
        ...
        ["ParkRunning3",        3840,   2160,   50,     10,     300,        64,          8,      0,      seqs_dir_vvc],

        ["MarketPlace",         1920,   1080,   60,     10,     600,        64,          8,      0,      seqs_dir_vvc],
        ["RitualDance",         1920,   1080,   60,     10,     600,        64,          8,      0,      seqs_dir_vvc],
        ["Cactus",              1920,   1080,   50,     8,      500,        64,          8,      0,      seqs_dir_hevc],
        ["BasketballDrive",     1920,   1080,   50,     8,      500,        64,          8,      0,      seqs_dir_hevc],
        ...
        ["PartyScene",          832,    480,    50,     8,      500,        64,          8,      0,      seqs_dir_hevc],
        ["BasketballDrill",     832,    480,    50,     8,      500,        64,          8,      0,      seqs_dir_hevc],

        ["RaceHorses",          416,    240,    30,     8,      300,        32,          8,      0,      seqs_dir_hevc],
        ["BQSquare",            416,    240,    60,     8,      600,        64,          8,      0,      seqs_dir_hevc],
        ["BlowingBubbles",      416,    240,    50,     8,      500,        64,          8,      0,      seqs_dir_hevc],
        ["BasketballPass",      416,    240,    50,     8,      500,        64,          8,      0,      seqs_dir_hevc],
        #
        ...
        ["SlideShow",           1280,   720,    20,     8,      500,        32,          8,      0,      seqs_dir_hevc],
    ]
    # @formatter:on
