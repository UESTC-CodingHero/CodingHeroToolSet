...
def main():
    ...
    seq_info = [
        ...
        ["Tango2",              3840,   2160,   60,     10,     294,        1,          8,      0,      seqs_dir],
        ["ParkRunning3",        3840,   2160,   50,     10,     300,        1,          8,      0,      seqs_dir],
        ["Campfire",            3840,   2160,   30,     10,     300,        1,          8,      0,      seqs_dir],
        ["DaylightRoad2",       3840,   2160,   60,     10,     300,        1,          8,      0,      seqs_dir],

        ["MarketPlace",         1920,   1080,   60,     10,     600,        1,          8,      0,      seqs_dir],
        ["RitualDance",         1920,   1080,   60,     10,     600,        1,          8,      0,      seqs_dir],
        ["Cactus",              1920,   1080,   50,     8,      500,        1,          8,      0,      seqs_dir],
        ["BasketballDrive",     1920,   1080,   50,     8,      500,        1,          8,      0,      seqs_dir],

        ["City",                1280,   720,    60,     8,      600,        1,          8,      0,      seqs_dir],
        ["Crew",                1280,   720,    60,     8,      600,        1,          8,      0,      seqs_dir],
        ["vidyo1",              1280,   720,    60,     8,      600,        1,          8,      0,      seqs_dir],
        ["vidyo3",              1280,   720,    60,     8,      600,        1,          8,      0,      seqs_dir],
    ]
    # @formatter:on
